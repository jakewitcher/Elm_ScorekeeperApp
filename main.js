...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{name: '', playerId: elm$core$Maybe$Nothing, players: _List_Nil, plays: _List_Nil},
...
var author$project$Main$deletePlay = F2(
	function (model, play) {
		var newPlays = A2(
			elm$core$List$filter,
			function (p) {
				return !_Utils_eq(p.id, play.id);
			},
			model.plays);
		var newPlayers = A2(
			elm$core$List$map,
			function (player) {
				return _Utils_eq(player.id, play.playerId) ? _Utils_update(
					player,
...
var author$project$Main$add = function (model) {
	var newPlayer = A3(
		...
		model.name,
		0);
	var newPlayers = A2(elm$core$List$cons, newPlayer, model.players);
	return _Utils_update(
		model,
...
var author$project$Main$edit = F2(
	function (model, id) {
		...
		var newPlayers = A2(
			elm$core$List$map,
			function (player) {
				return _Utils_eq(player.id, id) ? _Utils_update(
					player,
		...
		return _Utils_update(
			model,
			{name: '', playerId: elm$core$Maybe$Nothing, players: newPlayers, plays: newPlays});
	});
var author$project$Main$save = function (model) {
	var _n0 = model.playerId;
	if (_n0.$ === 'Just') {
		var id = _n0.a;
		return A2(author$project$Main$edit, model, id);
	} else {
		return author$project$Main$add(model);
	}
};
var author$project$Main$Play = F4(
	function (id, playerId, name, points) {
		return {id: id, name: name, playerId: playerId, points: points};
	});
var author$project$Main$score = F3(
	function (model, scorer, points) {
		...
		var newPlayers = A2(
			elm$core$List$map,
			function (player) {
				return _Utils_eq(player.id, scorer.id) ? _Utils_update(
					player,
		...
		switch (msg.$) {
			...
			case 'Cancel':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{name: '', playerId: elm$core$Maybe$Nothing}),
					elm$core$Platform$Cmd$none);
			case 'Save':
			...
			case 'Score':
				...
				var points = msg.b;
				return _Utils_Tuple2(
					A3(author$project$Main$score, model, player, points),
					elm$core$Platform$Cmd$none);
			case 'Edit':
				var player = msg.a;
				return _Utils_Tuple2(
			...
			default:
				var play = msg.a;
				return _Utils_Tuple2(
					A2(author$project$Main$deletePlay, model, play),
					elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$playMod = function (play) {
	return A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
...
var author$project$Main$playList = function (model) {
	return A2(
		elm$html$Html$ul,
		_List_Nil,
		A2(elm$core$List$map, author$project$Main$playMod, model.plays));
};
var elm$html$Html$header = _VirtualDom_node('header');
var author$project$Main$playListHeader = A2(
...
var author$project$Main$playSection = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				author$project$Main$playListHeader,
...
var author$project$Main$playerForm = function (model) {
	return A2(
		elm$html$Html$form,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$placeholder('Add/Edit Player'),
...
var author$project$Main$playerMod = function (player) {
	return A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$type_('button'),
						elm$html$Html$Events$onClick(
						A2(author$project$Main$Score, player, 2))
					]),
				_List_fromArray(
					[
						elm$html$Html$text('2pt')
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Attributes$type_('button'),
						elm$html$Html$Events$onClick(
						A2(author$project$Main$Score, player, 3))
					]),
				_List_fromArray(
					[
...
var author$project$Main$playerList = function (model) {
	return A2(
		elm$html$Html$ul,
		_List_Nil,
		A2(
			elm$core$List$map,
			author$project$Main$playerMod,
			A2(
...
var author$project$Main$playerListHeader = A2(
	elm$html$Html$header,
	_List_Nil,
	_List_fromArray(
		[
...
var author$project$Main$pointTotal = function (model) {
...
var author$project$Main$playerSection = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				author$project$Main$playerListHeader,
				author$project$Main$playerList(model),
				author$project$Main$pointTotal(model)
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$Main$playerSection(model),
						author$project$Main$playerForm(model),
						author$project$Main$playSection(model)
					]))
			]),
